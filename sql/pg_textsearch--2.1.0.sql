-- pg_textsearch extension version 2.1.0
--
-- 2.1.0: Maintenance release. Inherits the 2.0.0 clean-slate format,
-- where pre-2.0 indexes are not readable and require DROP/CREATE.
-- Carries forward:
...
BEGIN
    ...
    END IF;
    IF lib_ver OPERATOR(pg_catalog.<>) '2.1.0' THEN
        RAISE EXCEPTION
...
DO $$
BEGIN
    RAISE INFO 'pg_textsearch v2.1.0';
END
$$;
